...
# Here is the updated compiled code:
...
#     plt.imsave(f'test_filtering_frames/clipped_img/clipped_image_{outer_radius}.jpg', img_clipped, cmap='gray')
#     plt.imsave(f'test_filtering_frames/clipped_magnitude/clipped_magnitude_spectrum_{outer_radius}.jpg', 
#                magnitude_spectrum_clipped, cmap='gray')
#     plt.imsave(f'test_filtering_frames/clipped_phase/clipped_phase_spectrum_{outer_radius}.jpg',
...
#     fig.savefig(f'test_filtering_frames/clipped_3d_magnitude/3d_clipped_magnitude_spectrum_{outer_radius}.jpg', dpi = 200)
    
#     fig = plt.figure()
#     ax = fig.add_subplot(111, projection='3d')
#     ax.plot_surface(X, Y, phase_spectrum_clipped, cmap='magma')
#     fig.savefig(f'test_filtering_frames/clipped_3d_phase/3d_clipped_phase_spectrum_{outer_radius}.jpg', dpi = 200)
...
# directory = 'test_filtering_frames'
# os.makedirs(directory)

# # Create the subdirectories
# subdirectory1 = os.path.join(directory, 'clipped_img')
# os.makedirs(subdirectory1)

# subdirectory2 = os.path.join(directory, 'clipped_magnitude')
# os.makedirs(subdirectory2)


# subdirectory3 = os.path.join(directory, 'clipped_phase')
# os.makedirs(subdirectory3)

# subdirectory4 = os.path.join(directory, 'clipped_3d_magnitude')
# os.makedirs(subdirectory4)


# subdirectory5 = os.path.join(directory, 'clipped_3d_phase')
# os.makedirs(subdirectory5)


    
# for i in range (0,350,5):
#     fourier_transform('arch.png',0+i ,30 + i)
