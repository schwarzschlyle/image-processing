...
def fourier_mask(image_path, inner_radius, outer_radius, sweep_type):
    ...
    plt.imsave(f'{image_path}_{sweep_type}_rendering/magnitude_spectrum.jpg', 
               magnitude_spectrum, cmap='gray')
    plt.imsave(f'{image_path}_{sweep_type}_rendering/phase_spectrum.jpg',
               phase_spectrum, cmap='gray')
    ...
    fig.savefig(f'{image_path}_{sweep_type}_rendering/3d_magnitude_spectrum.jpg', dpi = 200)

    fig = plt.figure()
    ax = fig.add_subplot(111, projection='3d')
    ax.plot_surface(X, Y, phase_spectrum, cmap='magma')
    fig.savefig(f'{image_path}_{sweep_type}_rendering/3d_phase_spectrum.jpg', dpi = 200)
